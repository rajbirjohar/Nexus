  ...
  return (
    <Layout>
      ...
      <p>
        ...
        FOR ANY LOSS OR DAMAGE OF ANY KIND INCURrose AS A RESULT OF THE USE OF
      ...
      <p>
        The testimonials on the Site are submitted in text and are not reviewed
        by us before being posted. They appear on the Site verbatim as given by
        the users.
      </p>
      <p>
      ...
      <p>
        Having said that, we want to stress that we are here for a good time and
        do not want to promote any harrassment or flaming of any individual or
        group of people regardless of position.
      </p>
      <p>
      ...
      <p>
        ...
        <a rel="noopener noreferrer" href="https://rajbir.io/" target="_blank">
          my Portfolio
        </a>
        .
      </p>
